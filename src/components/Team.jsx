...
export default function Team() {
  ...
  const categories = [
    ...
    },
    {
      ...
      members: [
        { id: 8, img: team7, name: "Zainab Waris", role: "Graphic Designer / Commercial Analyst" },
        { id: 9, img: team7, name: "Ayesha Usman", role: "Graphic Designer / Commercial Analyst" },
        { id: 10, img: team7, name: "Zara Khurram", role: "Digital Marketing Consultant" },
        { id: 11, img: team7, name: "Manahil Khurram", role: "Digital Marketing Consultant" },
        { id: 12, img: team7, name: "Fatima Raza", role: "Digital Marketing Consultant" },
      ]
    }
  ];
        ...
        {categories.map((category, catIndex) => (
          <div key={catIndex} className="mb-12 last:mb-0">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 font-sans text-sm text-[black]/100">
