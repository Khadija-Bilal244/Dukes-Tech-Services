...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative overflow-hidden bg-white min-h-screen md:min-h-[90vh] flex items-center pt-16 md:pt-0">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:py-12 lg:py-16 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1">
            ...
            <h1 className="font-sans font-bold leading-[1.1] text-[#0E2A43]">
            ...
            {/* Description */}
            <p className="mt-4 sm:mt-5 max-w-lg text-sm sm:text-base md:text-lg leading-relaxed text-[#0E2A43]/70">
            ...
            <div className="mt-6 sm:mt-7 flex flex-wrap gap-3 sm:gap-4">
              ...
              <a
                href="#services"
                className="inline-flex items-center gap-2 rounded-full border-2 border-[#0E2A43]/10 px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-3.5 text-xs sm:text-sm font-semibold text-[#0E2A43] transition-all hover:bg-[#0E2A43] hover:text-white hover:border-[#0E2A43]"
              >
                Explore Services
              </a>
            </div>
