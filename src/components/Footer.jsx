            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-1">
              {SERVICES.map((service, index) => (
                <Link
                  key={index}
                  to="/services"
                  className="group flex items-center gap-2.5 py-1.5 px-2 rounded-lg hover:bg-white/5 transition-all duration-300 hover:translate-x-1"
                >
                  <span className="text-[#1CA7B8] text-base leading-none flex-shrink-0">•</span>
