    ...
    <section className="bg-[#F2FAFB] py-16 px-4 sm:px-6 lg:py-24">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <span className="inline-block rounded-full bg-[#1CA7B8]/10 px-6 py-2 text-base font-bold uppercase tracking-[0.15em] text-[#1CA7B8] font-sans border border-[#1CA7B8]/20">
            Get in Touch
          </span>
          ...
          <p className="mt-5 text-[black] max-w-2xl mx-auto font-sans text-base sm:text-lg leading-relaxed">
            Dukes Tech Services is your trusted partner for innovative technology solutions, 
            custom web development, creative design, digital marketing, and IT consulting. 
            We're committed to empowering your business with reliable, scalable, and future-ready 
            technology that drives growth and digital transformation.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-6">
              <div className="flex flex-col gap-2">
                <label className="text-base font-bold uppercase tracking-wider text-[black] font-sans">
                ...
                <input
                  ...
                  className="w-full px-5 py-4 border-2 border-[#0E2A43]/10 rounded-xl text-base text-[#0E2A43] bg-white outline-none transition-all duration-300 focus:border-[#1CA7B8] focus:shadow-[0_0_0_4px_rgba(28,167,184,0.12)] placeholder:text-[#0E2A43]/60 font-sans"
                  required
                />
              </div>
              <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2 mb-6">
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="5"
                className="w-full px-5 py-4 border-2 border-[#0E2A43]/10 rounded-xl text-base text-[#0E2A43] bg-white outline-none transition-all duration-300 focus:border-[#1CA7B8] focus:shadow-[0_0_0_4px_rgba(28,167,184,0.12)] placeholder:text-[#0E2A43]/60 font-sans resize-y"
                required
              />
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div className="group bg-white rounded-2xl p-8 text-center shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-[#0E2A43]/5 hover:border-[#1CA7B8]/30">
            ...
            <h4 className="mt-4 font-sans font-bold text-black text-lg">
              Email Us
            </h4>
            <a 
              href="mailto:info.dukestech@gmail.com" 
              className="font-sans text-[#1CA7B8] font-semibold hover:underline block mt-2 text-lg"
            >
          ...
          <div className="group bg-white rounded-2xl p-8 text-center shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-[#0E2A43]/5 hover:border-[#1CA7B8]/30">
            ...
            <span className="font-sans text-[#1CA7B8] font-semibold block mt-2 leading-relaxed text-lg">
